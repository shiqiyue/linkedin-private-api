...
\+ **new MessageScroller**(`__namedParameters`: { conversationId: string ; createdBefore: Date ; fetchMessages: FetchMessages  }): [MessageScroller](_src_scrollers_message_scroller_.messagescroller.md)
...
*Defined in [src/scrollers/message.scroller.ts:20](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/message.scroller.ts#L20)*

#### Parameters:

Name | Type |
------ | ------ |
`__namedParameters` | { conversationId: string ; createdBefore: Date ; fetchMessages: FetchMessages  } |
...
*Defined in [src/scrollers/created-before-scroller.ts:4](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/created-before-scroller.ts#L4)*
...
*Defined in [src/scrollers/message.scroller.ts:37](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/message.scroller.ts#L37)*
...
*Defined in [src/scrollers/created-before-scroller.ts:43](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/created-before-scroller.ts#L43)*
...
*Defined in [src/scrollers/created-before-scroller.ts:33](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/created-before-scroller.ts#L33)*
...
*Defined in [src/scrollers/created-before-scroller.ts:18](https://github.com/eilonmore/linkedin-private-api/blob/7c25b88/src/scrollers/created-before-scroller.ts#L18)*
